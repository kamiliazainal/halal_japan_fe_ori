...
constructor(props){
  ...
  fetchData = async () => {
    ...
    .then(res => {
      ...
      const data = res.data;
      const newData = data.filter(x => x.area == 'Osaka')
      //console.log(newData);
 ...
 renderListOfOsakaRestaurant = ({item}) => (
    ...
    return (
      <View style={styles.container}>
        <FlatList
          ...
          renderItem={this.renderListOfOsakaRestaurant}
        />
...
export default withNavigation(Osaka);
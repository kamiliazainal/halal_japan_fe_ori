...
constructor(props){
  ...
  fetchData = async () => {
    ...
    .then(res => {
      ...
      const data = res.data;
      const newData = data.filter(x => x.area == 'Kyoto')
      //console.log(newData);
 ...
 renderListOfKyotoRestaurant = ({item}) => (
    ...
    return (
      <View style={styles.container}>
        <FlatList
          ...
          renderItem={this.renderListOfKyotoRestaurant}
        />
...
export default withNavigation(Kyoto);